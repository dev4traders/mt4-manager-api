...
class UserApi
{
     ...
     * @param  \Swagger\Client\Model\UserAuth $body {\&quot;login\&quot;: 1, \&quot;password\&quot;:\&quot;pwd\&quot;} (required)
     *
     ...
     * @param  \Swagger\Client\Model\User $body {\&quot;password\&quot;:\&quot;new_pwd\&quot;, \&quot;name\&quot;:\&quot;new_name\&quot;} (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $token Session token (required)
     * @param  \Swagger\Client\Model\User $body {\&quot;login\&quot;: 1, \&quot;password\&quot;:\&quot;pwd\&quot;, \&quot;name\&quot;:\&quot;name\&quot;, \&quot;email\&quot;: \&quot;1@1.com\&quot;} (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $token Session token (required)
     * @param  \Swagger\Client\Model\BalanceType $body {\&quot;login\&quot;: 1, \&quot;amount\&quot;:1, \&quot;is_credit\&quot;: true, \&quot;comment\&quot;: \&quot;F.Management\&quot;} (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $token Session token (required)
     * @param  \Swagger\Client\Model\BalanceType $body {\&quot;login\&quot;: 1, \&quot;amount\&quot;:1, \&quot;is_credit\&quot;: true, \&quot;check_free_margin\&quot;: false, \&quot;comment\&quot;: \&quot;F.Management\&quot;} (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $token Session token (required)
     * @param  \Swagger\Client\Model\Users $body {\&quot;groupname\&quot;:\&quot;demohfx-usd\&quot;,\&quot;password\&quot;:\&quot;123456Aa\&quot;, \&quot;firstname\&quot;:\&quot;test\&quot;, \&quot;firstname\&quot;:\&quot;test\&quot;, \&quot;email\&quot;: \&quot;test@test.com\&quot;} (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ArrayOfUserResponses
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ArrayOfUserResponses, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersBulkAddPostWithHttpInfo($token, $body)
    {
        $returnType = '\Swagger\Client\Model\ArrayOfUserResponses';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ArrayOfUserResponses',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ArrayOfLogins
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ArrayOfLogins, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersGetWithHttpInfo($token)
    {
        $returnType = '\Swagger\Client\Model\ArrayOfLogins';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ArrayOfLogins',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
